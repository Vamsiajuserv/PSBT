...
const priceLabel = (s) =>
  s.committee ? '₹0' : `${s.from ? tr('from') + ' ' : ''}₹${fmt(s.amount)}`
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <td className="py-1.5 text-right font-semibold text-maroon-700">
                                          {s.committee ? <span className="font-semibold">₹0</span> : <span className="whitespace-nowrap">₹{fmt(s.amount)}</span>}
                                        </td>
                                      </tr>
                                    )
                                  })}
      ...
      <div className="flex-1 p-3.5 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <div className="sm:text-right shrink-0">
          ...
          <div className="text-lg font-extrabold text-maroon-700 leading-tight">
            {seva.committee ? <span className="font-semibold">₹0</span> : <>₹{fmt(seva.amount)}</>}
          </div>
          <button
            onClick={onView}
                  ...
                  <div key={selected.plan}
                    ...
                    <div className="flex items-baseline gap-2 mt-1">
                      ...
                      <span className="text-xl font-extrabold text-maroon-700">
                        {selected.committee ? <span className="font-semibold">₹0</span> : `₹${fmt(selected.amount)}`}
                      </span>
                    </div>
                  </div>
                )}
