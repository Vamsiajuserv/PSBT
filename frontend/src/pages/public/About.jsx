    ...
    <div className="bg-cream">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid lg:grid-cols-[300px_1fr_300px] gap-8">
        ...
        <div>
          ...
          <div className="text-gray-600 leading-relaxed space-y-4 mt-5">
            <p>{ABOUT.intro}</p>
            <p>{ABOUT.mission}</p>
          </div>
          <div className="bg-gold-50 border-l-4 border-gold-400 rounded-r-xl px-5 py-4 mt-6">
            ...
            <p className="text-xs text-gray-500 mt-1">— Shri Sai Baba</p>
          </div>
            ...
            {INFO.map((it) => {
              ...
              return (
                <div key={it.label} className="flex gap-3">
                  ...
                  <div>
                    <div className="text-[11px] font-bold uppercase tracking-wide text-gold-600">{it.label}</div>
                    <div className="text-sm text-gray-700 leading-snug">{it.value}</div>
                  </div>
                </div>
              )
            })}
          ...
          {PRINCIPLES.map((p) => {
            ...
            return (
              <div key={p.title} className="card p-5 text-center hover:-translate-y-1 transition-transform">
                ...
                <p className="text-[11px] text-gray-500 mt-1.5 leading-relaxed">{p.desc}</p>
              </div>
            )
          })}
        </div>
