...
export function TicketRef({ code }) {
  return (
    <div className="text-right shrink-0 flex flex-col items-end">
      ...
      <div className="text-[0.5625rem] text-gray-400 mt-0.5">{tr("Scan to verify")}</div>
    </div>
  )
}
...
export function TicketShell({ code, children }) {
  return (
    <div className="bg-[#fdf7ee] border-2 border-dashed border-amber-300 rounded-2xl p-5 md:p-6">
      ...
      <div className="text-center my-4"><span className="inline-block bg-maroon-800 text-cream text-[0.75rem] font-bold tracking-wider rounded px-4 py-1.5">{tr("POOJA BOOKING TICKET")}</span></div>
