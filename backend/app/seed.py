...
POOJAS = [
    ...
    ("Devi Navaratri Pooja", "దేవీ నవరాత్రి పూజ", "Occasion",
     [("1-Day", "1-Day", None, 1), ("9-Day", "9-Day", None, 9)]),
    ("Vinayaka Chavithi Pooja", "వినాయక చవితి పూజ", "Occasion",
     [("1-Day", "1-Day", None, 1), ("3-Day", "3-Day", None, 3), ("5-Day", "5-Day", None, 5),
      ("9-Day", "9-Day", None, 9), ("11-Day", "11-Day", None, 11)]),
    ("Karthika Masam Pooja", "కార్తీక మాస పూజ", "Occasion",
     [("1-Day", "1-Day", None, 1), ("Full Month", "30-Day", None, 30)]),
    ("Sri Rama Navami", "శ్రీ రామ నవమి", "Occasion", [("One-Time", "One-Time", None, None)]),
